...
namespace Utility.UI
{
    public class MessageBox : UIObject
    {
        ...
        public MessageBox(Point position, string prompt = null, string buttontext = null)
        {
            ...
            background = TextureRenderer.Render(CONTENT_MANAGER.spriteBatch, new Vector2(240, 100), Vector2.Zero, Color.White, 1, Primitive2DActionGenerator.FillRectangle(new Rectangle(Point.Zero, new Point(240, 100)), Color.LightGray));
