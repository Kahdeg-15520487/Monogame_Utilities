...
namespace Utility.Drawing
{
    public static class Primitive2DActionGenerator
    {
        ...
        {
            return DrawRectangle(rect, color, 1.0f);
        }
        ...
        {
            return DrawRectangle(new Rectangle((int)location.X, (int)location.Y, (int)size.X, (int)size.Y), color, 1.0f);
        }
        ...
        {
            return DrawRectangle(new Rectangle((int)location.X, (int)location.Y, (int)size.X, (int)size.Y), color, thickness);
        }
        ...
        {
            return DrawLine(new Vector2(x1, y1), new Vector2(x2, y2), color, 1.0f);
        }
        ...
        {
            return DrawLine(new Vector2(x1, y1), new Vector2(x2, y2), color, thickness);
        }
        ...
        {
            return DrawLine(point1, point2, color, 1.0f);
        }
        ...
        {
            return DrawLine(point, length, angle, color, 1.0f);
        }
        ...
        public static Action<SpriteBatch> PutPixel(float x, float y, Color color)
        {
            return PutPixel(new Vector2(x, y), color);
        }


        public static Action<SpriteBatch> PutPixel(Vector2 position, Color color)
        {
            return (sp) =>
            {
                if (pixel == null)
        ...
        public static Action<SpriteBatch> DrawCircle(Vector2 center, float radius, int sides, Color color)
        {
            return DrawPoints(center, CreateCircle(radius, sides), color, 1.0f);
        }
        ...
        public static Action<SpriteBatch> DrawCircle(Vector2 center, float radius, int sides, Color color, float thickness)
        {
            return DrawPoints(center, CreateCircle(radius, sides), color, thickness);
        }
        ...
        /// <param name="sides">The number of sides to generate</param>
        /// <param name="color">The color of the circle</param>
        public static Action<SpriteBatch> DrawCircle(float x, float y, float radius, int sides, Color color)
        {
            return DrawPoints(new Vector2(x, y), CreateCircle(radius, sides), color, 1.0f);
        }
        ...
        /// <param name="color">The color of the circle</param>
        /// <param name="thickness">The thickness of the lines used</param>
        public static Action<SpriteBatch> DrawCircle(float x, float y, float radius, int sides, Color color, float thickness)
        {
            return DrawPoints(new Vector2(x, y), CreateCircle(radius, sides), color, thickness);
        }
        ...
        public static Action<SpriteBatch> DrawArc(Vector2 center, float radius, int sides, float startingAngle, float radians, Color color)
        {
            return DrawArc(center, radius, sides, startingAngle, radians, color, 1.0f);
        }
